...
SELECT DISTINCT
    ...
    T1.PK_ITEMS AS FK_ITEMS, T1.UT_EID, T1.FK_SOURCES, t2.SOURCETITLE, T1.PAGE_CNT, T1.PUBTYPE, T1.DOCTYPE, T1.AUTHOR_CNT
FROM
...
ON
    ...
    AND t1.PK_ITEMS NOT IN (SELECT FK_ITEMS FROM BIORXIV_PUBLISHED_ARTICLES)
INNER JOIN
    BIORXIV_CR_DATES t3
ON
    LOWER(t1.DOI) = t3.DOI
