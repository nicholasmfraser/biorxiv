...
getGenderFromName<- function(FIRSTNAME, COUNTRYCODE) {
  ...
  # If gender unknown, try without country arguments
...
write.csv(first_author_names_gender,
          file="data/first_author_names_gender.csv", 
          row.names=FALSE, 
          fileEncoding="UTF-8")
write.csv(last_author_names_gender,
          file="data/last_author_names_gender.csv", 
          row.names=FALSE, 
          fileEncoding="UTF-8")
