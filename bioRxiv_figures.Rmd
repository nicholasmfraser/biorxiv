...
### Figure 4: Monthly citation rates of bioRxiv-deposited and control articles in IF categories
...
# Save plot    
ggsave("outputs/figures/fig_4_monthly_articles_cpp_IF.png", 
       plot, 
       width=width, 
       height=height_large, 
       units="cm", 
...
### Figure 5: Monthly citation rates for published and unpublished preprints
...
### Figure 6: Monthly citation rates for preprints as a function of time before/after journal publication

```{r results='hide'}

# Monthly Cpp of preprints.
...
### Figure 7: Altmetrics of preprints, bioRxiv-deposited and control articles

```{r results='hide'}

# Read altmetrics data for preprints and journal articles
...
### Figure 8: Altmetrics of bioRxiv-deposited and control articles in IF categories
...
altmetrics_IF <- read_csv("data/analysis/article_altmetrics_IF_summary.csv") %>%
  mutate(TYPE=factor(TYPE, levels=c("Deposited", "Control")),
         IF_CLASS=factor(IF_CLASS, levels=c("High IF", 
                                            "Med-High IF", 
                                            "Med-Low IF", 
                                            "Low IF")))
